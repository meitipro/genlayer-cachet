...
| `npm test` | 509 checks: 57 browser, 244 pure helpers, 208 driving the contract as a state machine. No GenVM, no network |
...
contracts/test_contract.py    208 checks driving it as a state machine
