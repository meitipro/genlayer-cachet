...
| `npm test` | 519 checks: 57 browser, 244 pure helpers, 218 driving the contract as a state machine. No GenVM, no network |
...
contracts/test_contract.py    218 checks driving it as a state machine
