...
export default function Intro() {
  ...
  useEffect(() => {
    ...
    // 1450ms delay + 520ms fade in `lg-out`, plus a frame of slack.
  ...
  return (
    <div
      ...
      style={{
        ...
        animation: "lg-out 520ms cubic-bezier(.4,0,1,1) 1450ms forwards",
      }}
    >
      <div
        style={{
      ...
      >
        <div style={{ position: "absolute", inset: "-14%", border: "1px solid rgba(232,120,94,.5)", borderRadius: "50%", animation: "lg-shock 900ms ease-out 240ms both" }} />
        <div style={{ position: "absolute", inset: "-14%", border: "1px solid rgba(232,120,94,.32)", borderRadius: "50%", animation: "lg-shock 1100ms ease-out 360ms both" }} />
        <svg
          viewBox="0 0 100 100"
          width="100%"
          height="100%"
          style={{
            ...
            animation: "lg-mark 380ms cubic-bezier(.22,1,.36,1) both",
          }}
        >
          <circle cx="50" cy="50" r="48" fill="none" stroke="#E8785E" strokeWidth="1.4" strokeDasharray="640" style={{ animation: "lg-draw 460ms cubic-bezier(.4,0,.2,1) both" }} />
          <circle cx="50" cy="50" r="48" fill="#A6321F" style={{ transformOrigin: "50% 50%", animation: "lg-disc 420ms cubic-bezier(.34,1.4,.5,1) both" }} />
          <g style={{ transformOrigin: "50% 50%", animation: "lg-ring 1400ms cubic-bezier(.16,1,.3,1) 200ms both" }}>
          ...
          <text
            ...
            fontSize="44"
            fill="#F6EEDE"
            style={{ transformOrigin: "50% 50%", animation: "lg-c 340ms cubic-bezier(.22,1,.36,1) 90ms both" }}
          >
            C
          </text>
        </svg>
      </div>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 11, animation: "lg-word 460ms cubic-bezier(.16,1,.3,1) 300ms both" }}>
        ...
        <span
          style={{
            ...
            animation: "lg-bar 700ms cubic-bezier(.22,1,.36,1) 420ms both",
          }}
        />
      </div>
    </div>
